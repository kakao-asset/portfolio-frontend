    ...
    const setSellMemberStock = () => {
        ...
        if (sellPrice < 0 || sellValue < 0 || sellPrice == "" || sellValue == "" || sellValue > stockValue || isNaN(sellPrice) || isNaN(sellValue) ) {
            ...
            axios({
                ...
                data: {
                    "price": sellPrice, "quantity": sellValue, "stockName": stockName, "stockCode": stockSymbolCode, "sectorCode": stockSectorCode, "sectorName": stockSectorName,
    ...
    const setBuyMemberStock = () => {
        if (buyPrice < 100 || buyValue < 0 || buyPrice == "" || buyValue == "" || isNaN(buyPrice) || isNaN(buyValue)) {
            ...
            axios({
                ...
                data: {
                    "price": buyPrice, "quantity": buyValue, "stockName": stockName, "stockCode": stockSymbolCode, "sectorCode": stockSectorCode, "sectorName": stockSectorName,
